...
sse_features_df = pd.DataFrame(sse_features)
sse_features_df.columns = sse_features_columns
sse_features_df.to_csv('D:/Work/MS COURSES/COURSES FALL 23/CSC 791 Natural Language Processing/LOLgorithm/LOLgarithm/dataset/syntactic-features.csv')
